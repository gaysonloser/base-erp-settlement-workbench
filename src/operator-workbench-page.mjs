...
<dt>Base Mainnet</dt><dd>Base Mainnet owner gate required · ${escapeHtml(mainnet.network ?? "base_mainnet")} · chain ${escapeHtml(mainnet.chain_id ?? 8453)} · ${mainnet.enabled === true ? "enabled" : "disabled"}</dd>
  ...
  const inspectorLinks = `<p class="inspector-links"><a href="/workbench.json?profile_id=${encodeURIComponent(profileId)}">Workbench JSON</a><a href="/simulate.json?profile_id=${encodeURIComponent(profileId)}">Simulation</a><a href="/release.json">Release</a></p>`;
...
</style><style>.truth-panel,.network-panel,.platform-gates-panel{border:1px solid #2a3954;border-radius:14px;padding:16px;margin:14px 0;background:#0d1728}.truth-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.truth-card{min-height:96px;padding:12px;border:1px solid #2a3954;border-radius:10px;background:#101d33}.truth-card strong,.truth-card span,.truth-card small{display:block}.truth-card span{margin:5px 0;color:#ffcf7d}.truth-card small{color:#8197bb}.network-panel dl{display:grid;grid-template-columns:150px 1fr;margin:0}.network-panel dt,.network-panel dd{padding:7px 0;border-bottom:1px solid #23314b}.network-panel dt{color:#8197bb}.network-panel dd{margin:0}.platform-gates-heading{display:flex;align-items:center;justify-content:space-between;gap:12px}.platform-gates-heading h3{margin:0}.platform-gates-heading a{display:inline-flex;align-items:center;min-height:44px;padding:9px 12px;border:1px solid #2c3b57;border-radius:9px}.platform-gates-rows{display:grid;gap:8px;margin-top:12px}.platform-gate-row{display:grid;gap:3px;padding:10px;border:1px solid #2a3954;border-radius:10px;background:#101d33}.platform-gate-row span{color:#ffcf7d}.platform-gate-row small{color:#8197bb}@media(max-width:760px){.truth-grid{grid-template-columns:1fr}.network-panel dl{grid-template-columns:1fr}}</style></head><body>
<div class="shell">
...
${truthHtml}${networkHtml}${platformGatesHtml}
